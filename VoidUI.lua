-- Load with: local VoidUI = loadstring(game:HttpGet("https://raw.githubusercontent.com/outhackernuls090-hash/VoidUI/refs/heads/main/VoidUI.lua"))()
local Modules = {}
local Cache = {}
...
local Utilities = VoidRequire("Core.Utilities")
local Physics = VoidRequire("Physics")
local Spring = VoidRequire("Spring")
...
local Utilities = VoidRequire("Utilities")
local Scheduler = VoidRequire("Scheduler")
local Events = VoidRequire("Events")
...
local Utilities = VoidRequire("Utilities")
local Events = VoidRequire("Events")
local Cleanup = VoidRequire("Cleanup")
local Scheduler = VoidRequire("Scheduler")
local State = VoidRequire("State")
local Animation = VoidRequire("Animation")
local Renderer = VoidRequire("Renderer")
local Window = VoidRequire("Window")
...
function ThemeManager:RegisterBuiltIns()
	local Default = VoidRequire("Default")
	local Midnight = VoidRequire("Midnight")
	local Nebula = VoidRequire("Nebula")
	local Crimson = VoidRequire("Crimson")
	local Emerald = VoidRequire("Emerald")
...
local Base = VoidRequire("Base")
local Icons = VoidRequire("Assets.Icons")
local Dropdown = VoidRequire("Dropdown")
...
function Tabs:CreateButton(Options)
	return self:_CreateWidget(VoidRequire("Button"), Options)
end

function Tabs:CreateToggle(Options)
	return self:_CreateWidget(VoidRequire("Toggle"), Options)
end

function Tabs:CreateSlider(Options)
	return self:_CreateWidget(VoidRequire("Slider"), Options)
end

function Tabs:CreateTextbox(Options)
	return self:_CreateWidget(VoidRequire("Textbox"), Options)
end

function Tabs:CreateDropdown(Options)
	return self:_CreateWidget(VoidRequire("Dropdown"), Options)
end

function Tabs:CreateSearchDropdown(Options)
	return self:_CreateWidget(VoidRequire("SearchDropdown"), Options)
end

function Tabs:CreateKeybind(Options)
	return self:_CreateWidget(VoidRequire("Keybind"), Options)
end

function Tabs:CreateColorPicker(Options)
	return self:_CreateWidget(VoidRequire("ColorPicker"), Options)
end

function Tabs:CreateGradientPicker(Options)
	return self:_CreateWidget(VoidRequire("GradientPicker"), Options)
end

function Tabs:CreateLabel(Options)
	return self:_CreateWidget(VoidRequire("Label"), Options)
end

function Tabs:CreateParagraph(Options)
	return self:_CreateWidget(VoidRequire("Paragraph"), Options)
end

function Tabs:CreateSection(Options)
	local Section = VoidRequire("Section").new(self.Application, self.Window.ContentScroll, Options)
	table.insert(self.Sections, Section)
	return Section
end

function Tabs:CreateDivider(Options)
	return self:_CreateWidget(VoidRequire("Divider"), Options)
end

function Tabs:CreateNotification(Options)
	return self:_CreateWidget(VoidRequire("Notification"), Options)
end

function Tabs:CreateProgress(Options)
	return self:_CreateWidget(VoidRequire("Progress"), Options)
end

function Tabs:CreateProgressRing(Options)
	return self:_CreateWidget(VoidRequire("ProgressRing"), Options)
end

function Tabs:CreateAccordion(Options)
	return self:_CreateWidget(VoidRequire("Accordion"), Options)
end

function Tabs:CreateTreeView(Options)
	return self:_CreateWidget(VoidRequire("TreeView"), Options)
end

function Tabs:CreateTable(Options)
	return self:_CreateWidget(VoidRequire("Table"), Options)
end

function Tabs:CreateConsole(Options)
	return self:_CreateWidget(VoidRequire("Console"), Options)
end

function Tabs:CreateTerminal(Options)
	return self:_CreateWidget(VoidRequire("Terminal"), Options)
end

function Tabs:CreateMarkdown(Options)
	return self:_CreateWidget(VoidRequire("Markdown"), Options)
end

function Tabs:CreateCodeEditor(Options)
	return self:_CreateWidget(VoidRequire("CodeEditor"), Options)
end

function Tabs:CreateGraph(Options)
	return self:_CreateWidget(VoidRequire("Graph"), Options)
end

function Tabs:CreateChart(Options)
	return self:_CreateWidget(VoidRequire("Chart"), Options)
end

function Tabs:CreateTimeline(Options)
	return self:_CreateWidget(VoidRequire("Timeline"), Options)
end

function Tabs:CreateImage(Options)
	return self:_CreateWidget(VoidRequire("Image"), Options)
end

function Tabs:CreateVideo(Options)
	return self:_CreateWidget(VoidRequire("Video"), Options)
end

function Tabs:CreateAudio(Options)
	return self:_CreateWidget(VoidRequire("Audio"), Options)
end

function Tabs:CreateFileExplorer(Options)
	return self:_CreateWidget(VoidRequire("FileExplorer"), Options)
end

function Tabs:CreateNestedTabs(Options)
	return self:_CreateWidget(VoidRequire("NestedTabs"), Options)
end
...
Modules["Widgets/init"] = function()
local Widgets = {}

Widgets.Base = VoidRequire("Base")
Widgets.Button = VoidRequire("Button")
Widgets.Toggle = VoidRequire("Toggle")
Widgets.Slider = VoidRequire("Slider")
Widgets.Textbox = VoidRequire("Textbox")
Widgets.Dropdown = VoidRequire("Dropdown")
Widgets.SearchDropdown = VoidRequire("SearchDropdown")
Widgets.Keybind = VoidRequire("Keybind")
Widgets.ColorPicker = VoidRequire("ColorPicker")
Widgets.GradientPicker = VoidRequire("GradientPicker")
Widgets.Label = VoidRequire("Label")
Widgets.Paragraph = VoidRequire("Paragraph")
Widgets.Section = VoidRequire("Section")
Widgets.Divider = VoidRequire("Divider")
Widgets.Notification = VoidRequire("Notification")
Widgets.Progress = VoidRequire("Progress")
Widgets.ProgressRing = VoidRequire("ProgressRing")
Widgets.Tabs = VoidRequire("Tabs")
Widgets.Accordion = VoidRequire("Accordion")
Widgets.TreeView = VoidRequire("TreeView")
Widgets.Table = VoidRequire("Table")
Widgets.Console = VoidRequire("Console")
Widgets.Terminal = VoidRequire("Terminal")
Widgets.Markdown = VoidRequire("Markdown")
Widgets.CodeEditor = VoidRequire("CodeEditor")
Widgets.Graph = VoidRequire("Graph")
Widgets.Chart = VoidRequire("Chart")
Widgets.Timeline = VoidRequire("Timeline")
Widgets.Image = VoidRequire("Image")
Widgets.Video = VoidRequire("Video")
Widgets.Audio = VoidRequire("Audio")
Widgets.FileExplorer = VoidRequire("FileExplorer")
Widgets.NestedTabs = VoidRequire("NestedTabs")
Widgets.CommandPalette = VoidRequire("CommandPalette")
Widgets.ContextMenu = VoidRequire("ContextMenu")
Widgets.Tooltip = VoidRequire("Tooltip")
Widgets.Modal = VoidRequire("Modal")
Widgets.Breadcrumbs = VoidRequire("Breadcrumbs")
